...
Current is very small, flow regime may be transient.
        ...
        Depth    P-dia Ver angl  Eff-sal     Temp  Polutnt  Density  P-speed   Dilutn   x-posn   y-posn   Iso dia
Step     (ft)     (in)    (deg)    (psu)      (C)    (ppb) (sigmaT)    (m/s)       ()     (ft)     (ft)       (m)
   0     140.0    2.000      0.0    1.340    22.50   1200.0 -1.26703    2.513    1.000      0.0      0.0       0.0;
   1     140.0    2.058   0.0174    3.129    21.88   1132.8  0.22983    2.369    1.059   0.0233      0.0   0.05229; bottom hit;
 100     139.9    14.68    7.819    28.36    13.20    163.1  21.2507    0.337    7.358    2.637      0.0    0.3728;
 200     138.3    32.47    36.35    30.80    12.36    67.05  23.2922    0.170    17.90    6.537      0.0    0.8247;
 300     132.8    52.27    64.64    31.73    12.04    30.41  24.0701    0.145    39.46    10.64      0.0    1.3276;
 337     125.8    72.25    74.92    32.07    11.93    17.13  24.3510    0.134    70.05    13.08      0.0    1.8352; merging;
 400     76.16    177.2    86.09    32.38    11.88    4.931  24.6045    0.148    243.4    19.29      0.0    4.5011;
 417     48.05    251.2    87.01    32.50    12.20    3.522  24.6326    0.138    340.8    20.89      0.0    6.3805; trap level;
 431     31.00    693.2    83.17    32.59    12.63    3.092  24.6262    0.053    388.1    22.04      0.0    17.607; begin overlap;
 458     29.23   1614.2    74.95    32.60    12.64    3.087  24.6260   0.0243    388.7    22.34      0.0    41.002; ceiling;
 473     29.05   2095.5    70.50    32.60    12.64    3.087  24.6260   0.0189    388.7    22.39      0.0    53.226; surface;
 
Horiz plane projections in effluent direction: radius(m):      0.0; CL(m):   6.8251
Lmz(m):   6.8251
forced entrain      1     0.0   33.82   53.23   0.329
Rate sec-1          0.0 dy-1          0.0  kt:          0.0 Amb Sal      33.4768
